    ...
    */
    ...
    inline bool TagCHIParameters::Deserialize(std::istream& is, std::string& errorMessage) noexcept
    {
        ...
        switch (parameters.GetIssue())
        {
            ...
            default:
                errorMessage = Gravity::StringAppender("Tag CHIParameters: unknown Issue value: ")
                    .Append(uint64_t(b))
                    .ToString();
                return false;
        }
        ...
        {
            errorMessage = Gravity::StringAppender("Tag CHIParameters: invalid NodeIdWidth value: ")
                .Append(uint64_t(b))
                .ToString();
            return false;
        }
        ...
        {
            errorMessage = Gravity::StringAppender("Tag CHIParameters: invalid ReqAddrWidth value: ")
                .Append(uint64_t(b))
                .ToString();
            return false;
        }
        ...
        {
            errorMessage = Gravity::StringAppender("Tag CHIParameters: invalid ReqRSVDCWidth value: ")
                .Append(uint64_t(b))
                .ToString();
            return false;
        }
        ...
        {
            errorMessage = Gravity::StringAppender("Tag CHIParameters: invalid DatRSVDCWidth value: ")
                .Append(uint64_t(b))
                .ToString();
            return false;
        }
        ...
        {
            errorMessage = Gravity::StringAppender("Tag CHIParameters: invalid DataWidth value: ")
    ...
    */
    ...
    inline bool TagCHITopologies::Deserialize(std::istream& is, std::string& errorMessage) noexcept
    {
        ...
        for (uint16_t i = 0; i < count; i++)
        {
            ...
            {
                errorMessage = Gravity::StringAppender("Tag CHITopologies: ")
    ...
    */
    ...
    inline bool TagCHIRecords::Deserialize(std::istream& is, std::string& errorMessage) noexcept
    {
        ...
        for (uint32_t i = 0; i < count; i++)
        {
            ...
            {
                errorMessage = Gravity::StringAppender("Tag CHIRecords: ")
                    .Append("record(", i, "): ")
